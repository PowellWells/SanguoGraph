...
describe('relation coverage audit', () => {
  it('freezes the current formal relation coverage baseline', () => {
    ...
    expect(report).toMatchObject({
      personCount: 577,
      relationCount: 333,
      relatedPersonCount: 348,
      isolatedPersonCount: 229,
      coveragePercent: 60.3,
      connectedComponentCount: 53,
      largestConnectedComponentSizes: [225, 9, 3, 3, 3, 3, 3, 3, 3, 3],
      byImportBatch: {
        ...
        6: { totalPeople: 232, relatedPeople: 68, isolatedPeople: 164 },
    ...
    expect(report.isolatedPersonIds).toHaveLength(229);
  });
  ...
  it('prioritizes unexpected family-batch gaps before roster research', () => {
    ...
    expect(queue.complete_roster).toHaveLength(165);
