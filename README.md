...
relationships in the Three Kingdoms period. The formal layer now covers 235
...
- 235 locally identified people (`person:sg:*`) across three import batches;
- 110 recorded father, mother, spouse, adoptive-parent, and clan relationships,
  with no political or battle edges;
- all 235 formal people load into the front-end map on first entry; people
...
Both builds use the 235 formal people as their adaptation boundary; the current
