...
- 284 条家庭关系；
- 138 条史料；
- 300 人至少拥有一条正式关系，257 人完全孤立，覆盖率 53.9%；
- 展示阵营：魏 273、蜀 120、吴 125、其他 39；
- 首次进入前端即加载全部 557 人和 284 条关系；
...
审计补录 24 条卷二十母子关系和 1 条孙权—孙虑父子关系，当前正式关系为 284 条。
...
- “适应画布”继续显示全部 557 人，极低缩放使用阵营色点总览；
...
- 默认地图加载 557 人、284 条关系；
- 搜索王蕃并显示“第六批全量导入”；
- 四阵营计数为 273、120、125、39；
- “适应画布”显示全部人物，放大后姓名可读；
...
本轮实测：lint 与 105 项测试通过，正式数据为 557／284／138；关系覆盖回归校验
通过，基线为 300 人有关系、257 人孤立。首页完整图谱引用 135 条史料。候选数据仍
为 99／738 且四个哈希一致；生产构建、临时目录离线构建和离线内联检查均通过，
`offline/index.html` 的既有未提交版本未被覆盖。曹氏最大连通分量扩展到 103 人后，
布局仍通过确定性、节点无重叠和边不穿越无关人物测试。
