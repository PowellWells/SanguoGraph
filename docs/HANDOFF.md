...
- 227 条家庭关系；
- 128 条史料；
- 245 人至少拥有一条正式关系，292 人完全孤立，覆盖率 45.6%；
- 展示阵营：魏 255、蜀 119、吴 124、其他 39；
- 首次进入前端即加载全部 537 人和 227 条关系；
...
袁氏补充新增 4 条原文明确关系；关系覆盖第一批随后新增 16 条魏系关系。当前正式
关系为 227 条。关系 JSON 序列化后的 SHA-256 为：

```text
f5adb7307d1b4a17fa6bc510134e87eec3b064d02988be9de5be699998c129aa
```
...
本轮实测：lint 通过，正式数据为 537／227／128；关系覆盖回归校验通过，基线为
245 人有关系、292 人孤立。首页当前
