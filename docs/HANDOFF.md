...
更新时间：2026-07-30
当前分支：`main`  
已验证实现基线：`934e044 feat: add radial collision-free graph layout`
...
- 1366×768：默认 18 人／27 关系、完整 24 人／33 关系均无节点重叠或连线穿过
  无关节点，页面无滚动；
- 搜索“夏侯惇”：隐藏支线按需加入，人物数为 19，目标人物自动居中；
- 关系标签在低缩放下自动收起，强制显示按钮和 `aria-pressed` 状态正常；
- 390×844：默认与完整图均无横向溢出，保持可读缩放并可在画布内平移；
