...
- 235 条家庭关系；
- 134 条史料；
- 257 人至少拥有一条正式关系，280 人完全孤立，覆盖率 47.9%；
- 展示阵营：魏 255、蜀 119、吴 124、其他 39；
- 首次进入前端即加载全部 537 人和 235 条关系；
...
8 条蜀系与其他关系。当前正式关系为 235 条。关系 JSON 序列化后的 SHA-256 为：

```text
34fecacaf35b6ce8ec3f62460a2814040c237384a5a2902639b96fda4a6e0d47
```
...
本轮实测：lint 通过，正式数据为 537／235／134；关系覆盖回归校验通过，基线为
257 人有关系、280 人孤立。首页完整图谱当前引用 131 条史料。候选数据仍为
99／738 且四个哈希一致；生产构建、临时目录离线构建和离线内联检查均通过。
