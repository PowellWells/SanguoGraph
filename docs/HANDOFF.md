...
- 200 条家庭关系；
- 121 条史料；
- 211 人至少拥有一条正式关系，326 人完全孤立，覆盖率 39.3%；
- 展示阵营：魏 255、蜀 119、吴 124、其他 39；
- 首次进入前端即加载全部 537 人和 200 条关系；
...
关系为 200 条。关系 JSON 序列化后的 SHA-256 为：

```text
390b9b5a48f93dc1f3c9a46f9058576f63dd3f6672b50c3ac741b9f26c8a531d
```
...
本轮实测：lint 通过，正式数据为 537／200／121；关系覆盖回归校验通过，基线为
211 人有关系、326 人孤立。首页当前
