...
- 收录235条父亲、母亲、夫妻、收养和宗族基础关系，不增加政治或战争关系线；
- 当前257人至少拥有一条正式关系，280人仍为孤立节点；[关系覆盖专项](docs/RELATION_COVERAGE.md)已完成120名主要人物的三批审核；
...
内嵌到 `index.html`，但仍默认隐藏。两种构建都以537名正式人物为适配边界；
