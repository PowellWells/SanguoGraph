...
Milestone 2 展示曹氏—夏侯氏人物网络，并严格分离已经核验的历史记录与外部结构化候选。
...
- 固定收录24名人物，全部使用项目本地 `person:sg:*` ID；
- 收录33条父亲、母亲、夫妻、收养和宗族基础关系；
...
内嵌到 `index.html`，但仍默认隐藏。两种构建都以24名正式人物为适配边界；
