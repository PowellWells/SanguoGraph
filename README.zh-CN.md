...
当前正式层覆盖270名魏、蜀、吴及汉末群雄人物，并严格分离已经核验的历史记录、
...
- 固定收录270名人物，全部使用项目本地 `person:sg:*` ID；
- 收录145条父亲、母亲、夫妻、收养和宗族基础关系，不增加政治或战争关系线；
- 首次进入即在前端加载全部270名人物，没有当前类型关系的人物作为独立节点显示；
...
内嵌到 `index.html`，但仍默认隐藏。两种构建都以270名正式人物为适配边界；
