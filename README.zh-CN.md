...
当前正式层覆盖577名魏、蜀、吴及汉末群雄人物，并严格分离已经核验的历史记录、
文学／传闻关系、展示阵营与内部研究候选。
...
- 固定收录577名人物，全部使用项目本地 `person:sg:*` ID；
- 收录353条父亲、母亲、夫妻、收养和宗族基础关系，不增加政治或战争关系线；
- 当前371人至少拥有一条正式关系，206人仍为孤立节点；[关系覆盖专项](docs/RELATION_COVERAGE.md)已完成全局遗漏与证据审计；
- 首次进入即在前端加载全部577名人物，没有当前类型关系的人物作为独立节点显示；
- 每条正式关系可查看《三国志》卷次、短引文和本地史料定位；
